...
class LihatProdukController extends Controller
{
    public function index()
    {
        ...
        return view('admin.lihat_produk.main_lihat_produk',['produk'=>$produk,'kategori'=>$kategori]);
    }
    ...
    public function cariProduk(Request $request)
    {
        ...
        if($request->kategori == null){
            ...
            return view('admin.lihat_produk.main_lihat_cari_produk',['produk'=>$produk,'kategori'=>$kategori,'hasil_pilih'=>$hasil_pilih]);
        }
    }
}
